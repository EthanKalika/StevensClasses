...
class Car(object):
    '''Write the constructor. It should take in four arguments:
       ...
       '''
    def __init__(self, make, model, mpg, tankCapacity):
        self.__make = make
        self.__model = model
        self.__mpg = mpg
        self.__tank_capacity = tankCapacity
    ...
    def set_tank_capacity(self, newTankCapacity):
        self.__tank_capacity = newTankCapacity
...
class HybridCar(Car):  
    ...
    '''
    def __init__(self, make, model, mpg, tankCapacity, batteryKWh, milesPerKWh):
        super().__init__(make, model, mpg, tankCapacity)
        self.__battery_kWh = batteryKWh
        self.__miles_per_kWh = milesPerKWh
